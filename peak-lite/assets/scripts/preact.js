import {
  ...
  _unmount,
  options,
} from 'https://cdnjs.cloudflare.com/ajax/libs/preact/10.0.0-rc.0/preact.module.js';

//we do all of this so when preact is updated
//or a minified version is used, it doesn't have to be updated everywhere
...
function getHookState(index) {
  if (options._hook) {
    options._hook(currentComponent);
  }
  // Largely inspired by:
